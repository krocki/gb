...
#python gameboy.py --rom ./envs/ferrari.gb --logname ferrari
#python gameboy.py --rom ./envs/tetris.gb --logname tetris
#python gameboy.py --rom ./envs/prince.gb --logname prince
